...
5) *A variable, labeled num:5 is clicked and edited with the value being updated:* <br/>
6) *A command, fd 100, is clicked on in the history tab, which calls the command:* <br/>
